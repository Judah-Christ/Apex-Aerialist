...
public class LeafEnemyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.DrawLine(transform.position, transform.TransformDirection(Vector2.right) * distance, Color.red);

        RaycastHit2D hit = Physics2D.Raycast(transform.position, transform.TransformDirection(Vector2.right), distance, enemylayer);
